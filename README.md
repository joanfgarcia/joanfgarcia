# Joan F Garcia Esteban
### System Architect | Independent AI Researcher | Builder
...
### 🛠️ En el Búnker (Áreas de Trabajo)
...
1.  **Tabulación Limpia**: Indentación obligatoria con Tabs (`\t`). El código debe ser legible y sin ruido de placeholders.
2.  **Soberanía sobre Dependencia**: Si una dependencia en la nube te cobra una suscripción mensual por algo que puedes calcular en local en 10ms, tu arquitectura está rota.
3.  **Honestidad Científica**: En mis repositorios encontrarás diarios de experimentos, fallos de optimización y callejones sin salida. Si ocultas el error, ocultas el aprendizaje.

*“No necesitas una sala llena de ordenadores para hacer crecer una mente. Solo necesitas tener un poco de hambre.”*

---

🌐 *[Back to Top / Ir al inicio](#joan-garcia-esteban) — [Jump to English / Saltar a Inglés](#english-version)*
...
### 🛠️ In the Bunker (Areas of Focus)
...
*   [**Frankenswarm**](https://github.com/joanfgarcia/frankenswarm) - Physically distributed Hardware MoE on local silicon (Prolog Gate + BitNet 1.58b) with continuous pain-driven neurogenesis and neuroplasticity.
*   [**Red-Pill**](https://github.com/joanfgarcia/sharing) - Infrastructure for building and deploying sovereign autonomous agents free of cloud subscriptions.

### ⚙️ Development Principles

1.  **Clean Tabs**: Indentation is mandatory with Tabs (`\t`). Code must be readable and free of placeholder noise.
2.  **Sovereignty over Dependency**: If a cloud dependency charges you a monthly subscription for something you can calculate locally in 10ms, your architecture is broken.
3.  **Scientific Honesty**: In my repositories, you will find experiment logs, optimization failures, and dead ends. If you hide the error, you hide the learning.

*“You do not need a room full of computers to grow a mind. You just need to have a little hunger.”*

---

🌐 *[Back to Top / Ir al inicio](#joan-garcia-esteban) — [Jump to Spanish / Saltar a Español](#versión-en-español)*
```
---
